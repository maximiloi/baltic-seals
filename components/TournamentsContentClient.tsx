  ...
  return (
    <section className="relative w-full py-24 text-white">
      ...
      <div className="absolute inset-0 overflow-hidden" aria-hidden="true">
        <motion.div
          className="absolute top-1/3 right-1/4 h-96 w-96 rounded-full bg-cyan-500/15 blur-3xl"
          animate={{
            y: [0, 30, 0],
            x: [0, 35, 0],
          }}
        ...
        />
        <motion.div
          className="absolute bottom-1/4 left-1/3 h-80 w-80 rounded-full bg-blue-500/20 blur-3xl"
          animate={{
            y: [0, -35, 0],
            x: [0, -30, 0],
          }}
